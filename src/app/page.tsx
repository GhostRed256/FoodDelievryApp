...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col bg-[#070a07] text-zinc-100 font-sans selection:bg-amber-500 selection:text-black">
      <Header />

      {/* Hero Section with Luxury Gold & Emerald Aura */}
      <section className="relative flex flex-1 items-center justify-center overflow-hidden py-14 sm:py-24 px-4 md:px-6">
        ...
        <div className="absolute bottom-0 right-0 w-[350px] h-[350px] bg-emerald-900/10 blur-[90px] -z-10 pointer-events-none" />
