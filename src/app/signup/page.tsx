            ...
            <div className="w-full max-w-[420px] space-y-6 animate-in fade-in zoom-in duration-300">
                <div className="flex flex-col items-center text-center">
                    ...
                    <p className="mt-1 text-xs sm:text-sm text-zinc-400">
                        Join FoodNJoy today to order & track your food in Tinsukia
                    </p>
                </div>
                    ...
                    <form onSubmit={handleSignup} className="space-y-4">
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                <User className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-amber-400" />
                                <input
                                    type="text"
                                    required
                                    autoComplete="name"
                        ...
                        >
                            {loading ? <Loader2 className="h-4 w-4 animate-spin text-black" /> : "Sign Up"}
